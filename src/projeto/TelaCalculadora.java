...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                tela.setTitle("Calculadora"); //titulo para o Jform
                tela.setResizable(false); //desabilita o botao de maximizar a tela
            }
        });
    }
    ...
    private void mudaIcone() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/imagens/calculadora.png")));
    }
